...
item_data_table: dict[Items, SohItemData] = {
    ...
    Items.PROGRESSIVE_BOMBCHU: SohItemData(48, IC.progression | IC.useful, 0, item_groups=["Bombchu Bag", "Bombs"]),
    ...
    Items.EPONAS_SONG: SohItemData(67, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.SARIAS_SONG: SohItemData(68, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.SUNS_SONG: SohItemData(69, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.SONG_OF_TIME: SohItemData(70, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.SONG_OF_STORMS: SohItemData(71, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.MINUET_OF_FOREST: SohItemData(72, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.BOLERO_OF_FIRE: SohItemData(73, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.SERENADE_OF_WATER: SohItemData(74, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.REQUIEM_OF_SPIRIT: SohItemData(75, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.NOCTURNE_OF_SHADOW: SohItemData(76, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),
    Items.PRELUDE_OF_LIGHT: SohItemData(77, IC.progression | IC.useful, 1, item_type=ItemType.song, item_groups=["Songs", "Song"]),

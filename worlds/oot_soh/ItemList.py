...
major_items = [
    ...
    ("Goron Tunic", 1, ItemClassification.useful),
    ("Zora Tunic", 1, ItemClassification.useful),
    ("Iron Boots", 1, ItemClassification.useful),
    ("Hover Boots", 1, ItemClassification.useful),
    ("Boomerang", 1, ItemClassification.useful),
    ("Lens of Truth", 1, ItemClassification.useful),
    ("Megaton Hammer", 1, ItemClassification.useful),
    ("Stone of Agony", 1, ItemClassification.useful),
    ("Din's Fire", 1, ItemClassification.useful),
    ("Farore's Wind", 1, ItemClassification.useful),
    ("Nayru's Love", 1, ItemClassification.useful),
    ("Fire Arrow", 1, ItemClassification.useful),
    ("Ice Arrow", 1, ItemClassification.useful),
    ("Light Arrow", 1, ItemClassification.useful),
...
progressive_item_data = [
    ...
    ("Progressive Bomb Bag", (lambda options: 3), ItemClassification.useful),
    ("Progressive Bow", (lambda options: 3), ItemClassification.useful),
    ("Progressive Slingshot", (lambda options: 3), ItemClassification.useful),
    ("Progressive Ocarina", (lambda options: 1), ItemClassification.useful),
    ("Progressive Hookshot", (lambda options: 2), ItemClassification.useful),
    ("Strength Upgrade", (lambda options: 3), ItemClassification.useful),
    ...
    ("Progressive Magic Meter", (lambda options: 2), ItemClassification.useful),
    ("Progressive Bombchus", (lambda options: 1), ItemClassification.useful),
    ("Progressive Goron Sword", (lambda options: 0), ItemClassification.useful)
]
bottles_data = [
    ("Empty Bottle", 1, ItemClassification.useful),
...
dungeon_reward_data = [
    ...
    ("Zora Sapphire", 1, (lambda options: ItemClassification.useful)),
    ("Forest Medallion", 1, ItemClassification.useful),
    ("Fire Medallion", 1, ItemClassification.useful),
    ("Water Medallion", 1, ItemClassification.useful),
    ("Spirit Medallion", 1, (lambda options: ItemClassification.useful)),

...
would in the vanilla game. A list of perhaps non-obvious pieces of logic can be found in game using the built in check tracker. It can be enabled
...
## What does another world's item look like in SoH?
